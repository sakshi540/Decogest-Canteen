...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      <?php
       ...
       ?>
       <span class="name" name="current_dt" class="Form_control"><input type="datetime-local" id="dt" name="dt" placeholder="DT" required></span></p>
   ...
   <div class="user-info">
      ...
      <input type="submit" value="place order" class="btn" onclick="showAlert()"<?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit">

      <script>
   function showAlert() {
    alert ("Your order is placed it will be ready on time....");
  }
  </script>
   </div>
